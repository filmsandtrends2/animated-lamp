...
async def start(c, m):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Source 😒', url='@filmsandtrends_Owner'),
                    InlineKeyboardButton('Project Channel', url='@filmsandtrends')
                ],
                [
                    InlineKeyboardButton('My Father', url='@filmsandtrends')
                ]
            ]
        )
    )
